...
if page == "Live Translator":
    ...
    with prediction_column:
        ...
        st.markdown(
            ...
            4. SIGNOVA compares the landmark pattern against the
            dataset and records the closest matching letter
            automatically.<br>
...
# ============================================================
    ...
    st.write(
        ...
        **MediaPipe Hand Landmarks + Support Vector Machine (SVM)**
        ...
        Those {LANDMARKS_PER_HAND} points become a
        {FEATURES_PER_HAND}-number feature vector (x, y, z per
        point), re-centered on the wrist and rescaled by hand
        size so that the same sign looks the same whether it's
        close to or far from the camera. An RBF-kernel SVM then
        classifies that vector into one of the available
